                                ...
                                if($conn->connect_errno!=0){
                                  die("connection failed");
                                    ...
                                    while($row=$result->fetch_assoc())
                                    {
                                        ...
                                        echo "<td><button id='".$row['id']."'class='checkin  btn btn-primary'>Check In</button>&nbsp";
                                        echo "<button id='".$row['id']."'class='notvisited  btn btn-danger'>Not visited</button>&nbsp";
